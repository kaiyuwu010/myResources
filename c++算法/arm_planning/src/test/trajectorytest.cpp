...
void trajectoryPlanningTest()
{
    ...
    std::vector<double> point1 = {60, 30, 40, 60, 40, 45, 55};
    std::vector<double> point2 = {10, 55, 30, 70, 90, 30, 45};
    std::vector<double> point3 = {5, 30, 10, 15, 30, 50, 80};
    std::vector<double> point4 = {15, 55, 60, 20, 50, 45, 60};
    ...
    std::vector<double> v0(7, 12);
    std::vector<double> m0(7, 12);
    std::vector<double> vn(7, 20);
    std::vector<double> mn(7, 20);
